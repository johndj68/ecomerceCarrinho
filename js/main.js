...
function ready(){
    ...
    document.getElementsByClassName("btn-buy")[0].addEventListener("click",buybottonClicek)
}
function buybottonClicek (){
    alert("secess")
...
function addCartCliked(event){
    ...
    var price = shopProducts.getElementsByClassName("prince")[0].innerText;
